...
OUT_DIR = os.path.join(BASE_DIR, "results/hybrid_unet_rowmask_v1")
...
# Initial hybrid rules (strict version)
TH_WEED_BASE = 0.50          # base threshold for weed
TH_WEED_IN_ROW = 0.70        # inside crop row, require higher confidence
MIN_SIZE_IN_ROW = 4          # remove very small weed objects inside crop row
